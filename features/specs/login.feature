...
Scenario: Sucessful Login
    Given I am at the authenticatian page
        And I have an user "tt@xc.com" with password "12345"
    When I login 
...
Scenario: Login without filling e-mail address
    ...
    Then I should get "An e-mail address required" message
...
Scenario: Login with wrong password
    Given I am at the authenticatian page
        And I have an user "tt@xc.com" with a wrong password
    When I try to login
...
Scenario: Log out
    ...
    When I Logout
    Then I should redirect to the home menu
        And the link Sign in has to be available
